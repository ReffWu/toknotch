    ...
    static func all(in language: AppLanguage) -> [ReleaseNote] {
        [
            ReleaseNote(
                ...
                changes: [
                    ReleaseNote.Change(title: language.t("whatsNew.v128.icon.title"),
                                       detail: language.t("whatsNew.v128.icon.detail"))
                ]
            ),
            ReleaseNote(
                version: "1.2.7",
                headline: language.t("whatsNew.v127.headline"),
                changes: [
                    ReleaseNote.Change(title: language.t("whatsNew.v127.menuBar.title"),
                                       detail: language.t("whatsNew.v127.menuBar.detail"))
                ]
            ),
            ReleaseNote(
                version: "1.2.6",
                headline: language.t("whatsNew.v126.headline"),
                changes: [
                    ReleaseNote.Change(title: language.t("whatsNew.v126.panel.title"),
                                       detail: language.t("whatsNew.v126.panel.detail")),
                    ReleaseNote.Change(title: language.t("whatsNew.v126.dock.title"),
                                       detail: language.t("whatsNew.v126.dock.detail"))
                ]
            ),
            ReleaseNote(
                version: "1.2.5",
            ...
            ReleaseNote(
                ...
                changes: [
                    ReleaseNote.Change(title: language.t("whatsNew.v124.updates.title"),
                                       detail: language.t("whatsNew.v124.updates.detail"))
                ]
            ),
            ReleaseNote(
                version: "1.2.3",
                headline: language.t("whatsNew.v123.headline"),
                changes: [
                    ReleaseNote.Change(title: language.t("whatsNew.v123.antigravity.title"),
                                       detail: language.t("whatsNew.v123.antigravity.detail")),
                    ReleaseNote.Change(title: language.t("whatsNew.v123.tokscale.title"))
                ]
            ),
            ReleaseNote(
                version: "1.2.2",
                headline: language.t("whatsNew.v122.headline"),
                changes: [
                    ReleaseNote.Change(title: language.t("whatsNew.v122.more.title"),
                                       detail: language.t("whatsNew.v122.more.detail"))
                ]
            ),
            ReleaseNote(
                version: "1.2.1",
